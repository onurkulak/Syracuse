...
public class PopulationHappinessPanel extends JPanel{
    private BufferedImage background;
    JPanel panel = new JPanel();
    JLabel title = new JLabel("Population-Happiness",SwingConstants.CENTER);
    
    public PopulationHappinessPanel(){
        setLayout(null);
    ...
    @Override public void paintComponent(Graphics page){ 
   	super.paintComponent(page);
        try {background = ImageIO.read(getClass().getResource("/file/f.jpg"));} 
